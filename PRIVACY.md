# Privacy Policy for Search Router

**Last Updated: September 2026**

Search Router is engineered with an absolute **privacy-first architecture**. We believe that desktop tools should respect user privacy and operate with zero hidden tracking.

---

## 1. Executive Summary

- **Zero Telemetry**: Search Router collects **no** telemetry, usage metrics, analytics, or behavioral data.
...
- **No Access to Sensitive Data**: Search Router **never** reads or accesses your browsing history, saved passwords, authentication cookies, form autofill, or personal downloads.
...
To provide profile-aware browser routing, Search Router inspects standard Windows registry paths and browser configuration files:
...
Search Router utilizes Raycast's native, sandboxed LocalStorage strictly on your local PC to persist:
...
- **How It Works**:
  ...
  - **Opt-In Only**: If you do not open the feedback form and submit it, Search Router makes zero external network requests.

---

## 5. Third-Party Search Engines

When you execute a search query or open a URL, Search Router passes the target URL directly as a command-line argument to your chosen local browser executable. 
...
Search Router is completely open source under the permissive [MIT License](LICENSE). You can inspect every line of code, build the extension locally from source, and audit its network and disk activities at any time on GitHub.
